     ...
     <div className="mt-2">
        ...
        <div className='flex justify-center  border-[1px] border-gray-200 shadow-lg rounded-md py-4 px-5'>
           <div className='flex flex-col gap-2 flex-1'>
             ...
             <div className='flex relative text-orange-500'><Button children={"View All Tours"}  addStyle={"rounded-md border-[1px] border-orange-600"}/> </div>
           </div>

           <div className='flex-1'>
             <img className="rounded-md" src={videoImg} alt="" />
           </div>
        </div>
        {isDestLoad? 
        <div>
